...
//--------------------------------------------------------------------------------------- 
//---------------------------------------------------------------------------------------
class X2Effect_LW2WotC_Savior extends X2Effect_Persistent config(SoldierSkills_StimGun);
...
function RegisterForEvents(XComGameState_Effect EffectGameState)
{
	...
	EventMgr.RegisterForEvent(EffectObj, 'SG_Savior_Triggered', EffectGameState.TriggerAbilityFlyover, ELD_OnStateSubmitted, , UnitState);
...
static function EventListenerReturn ModifyMedikitHeal(Object EventData, Object EventSource, XComGameState NewGameState, Name InEventID, Object CallbackData)
{
    ...
    EventMgr = `XEVENTMGR;
	EventMgr.TriggerEvent('SG_Savior_Triggered', AbilityState, SourceUnit, NewGameState);
